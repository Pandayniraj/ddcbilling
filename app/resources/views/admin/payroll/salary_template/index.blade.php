                                            ...
                                            @foreach($templates as $tk => $tv)
                                                ...
                                                <!-- <td>{{ $tv->overtime_salary }}</td> -->
                                                    <td style="text-align:right;">
                                                        ...
                                                        <a href="/admin/payroll/template/duplicate/{{$tv->salary_template_id }}"><i class="fa fa-copy"></i></a>
                                                    </td>
                                                </tr>
                                            @endforeach
                                            </tbody>
                    ...
                    <div class="tab-pane @if(\Request::segment(4)) active @endif" id="new_template"
                        ...
                        <form action="/admin/payroll/salary_template" method="post"
                            ...
                            <div class="row">
                                ...
                                <div class="form-group" id="border-none">
                                    <label for="field-1" class="col-sm-3 control-label">CIT Deduction<span
                                            class="required"> *</span></label>
                                    <div class="col-sm-5">
                                        <input type="text" name="cit_deduction"
                                               value="@if($salaryTemplate){{ $salaryTemplate->cit_deduction }}@endif"
                                               class="form-control" required="" placeholder="Enter CIT Deduction Amount"
                                               >
                                    </div>
                                </div>
                                <div class="form-group" id="border-none">
                                    <label for="field-1" class="col-sm-3 control-label">Insurance Premium<span
                                            class="required"> *</span></label>
                                    <div class="col-sm-5">
                                        <input type="text" data-parsley-type="number" name="insurance_premium"
                                               value="@if($salaryTemplate){{ $salaryTemplate->insurance_premium }}@endif"
                                               class="insurance_premium form-control" required="" placeholder="Enter Insurance Premium"
                                               >
                                    </div>
                                </div>
                                {{-- <div class="form-group" id="border-none">
