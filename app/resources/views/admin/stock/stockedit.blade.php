    ...
    <div class='row'>
        <div class='col-md-12'>
            <div class="box box-header">
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><input type="number" id="quantity" name="quantity[{{$key}}]" value="{{$stock->qty}}"></td>
                            <td><input type="number" id="return_quantity" name="return_quantity[{{$key}}]" value="{{$stock->return_quantity}}" readonly></td>
                ...
                <div class="form-group">
                    {!! Form::button( trans('general.button.edit'), ['class' => 'btn btn-primary', 'id' => 'btn-submit-edit'] ) !!}
