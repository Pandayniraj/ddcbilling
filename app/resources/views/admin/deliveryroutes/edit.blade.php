...
<section class="content-header" style="margin-top: -35px; margin-bottom: 20px">
 ...
 <div class='row'>
   <div class='col-md-12'>
      <div class="box">
         <div class="box-body">
        <form method="post" action="{{route('admin.deliveryroute.update', $finddeliveryroute->id)}}" enctype="multipart/form-data">
            {{ csrf_field() }}
            <div class="row">
                <div class="col-md-4 col-sm-12 form-group">
                    <label class="control-label">Distributor</label>
                    <div class="input-group">
                        <Select name="distributor_id" class="form-control searchable input-sm">
                            <option value="" disable selected>Select Any One</option>
                            @foreach($distributor as $key=>$distributor)
                            <option value="{{$key}}" {{$finddeliveryroute->distributor_id == $key ? "selected":""}}>{{ $distributor}}</option>   
                            @endforeach
                        </Select>
                 ...
                 <div class="col-md-4 col-sm-12 form-group">
                    ...
                    <div class="input-group">
                      <input type="text" name="route_name" value="{{ $finddeliveryroute->route_name}}" class="form-control  input-sm" placeholder="Route Name">
                      <div class="input-group-addon">
                 ...
                 <div class="col-md-4 col-sm-12 form-group">
                     <label class="control-label">Route Code
                     </label>
                    <div class="input-group">
                      <input type="text" name="route_code" value="{{ $finddeliveryroute->route_code}}" class="form-control  input-sm" placeholder="Route Code">
                      <div class="input-group-addon">
         ...
         <div class="row">
                    <div class="col-md-12 ">
                        ...
                        <div class="form-group pull-right">
                            ...
                            <a href="/admin/deliveryroute/" title="{{ trans('general.button.cancel') }}" class='btn btn-default'>{{ trans('general.button.cancel') }}</a>
                        </div>
                        </div>
                 </div>
