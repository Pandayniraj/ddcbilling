                                ...
                                <div class="col-md-12">
                                     ...
                                     <div class="col-md-3">
                                        <label>Return Date:</label>
                                          <input type="text" class="form-control pull-right datepicker date-toggle-nep-eng name="return_date" value="{{$purchasereturn->return_date}}" id="return_date" required="" readonly>
                                     </div>

                                     <div class="col-md-3">
                                        <label>Purchase Order Date:</label>
                                        <input type="text" class="form-control pull-right datepicker date-toggle-nep-eng" name="purchase_order_date" value="{{$purchasereturn->purchase_order_date}}" id="purchase_order_date" readonly>
                                     </div>
