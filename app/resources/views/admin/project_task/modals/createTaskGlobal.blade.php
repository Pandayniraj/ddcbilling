              ...
              <form method="post" id="form_tasks" onsubmit="return submitform()">
                ...
                <div class="modal-body">
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-11">
                                  {!! Form::text('description', $task->description, ['class' => 'form-control input-sm required', 'id'=>'description','placeholder'=>'Detail']) !!}
                              </div>
                            </div>
                       ...
                       <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="subject" class="col-sm-4 control-label">
                            <i class="fa fa-users"></i> {{ trans('admin/projects/general.columns.people') }} <small> (Autocomplete)</small>
                            </label>
                            <div class="col-sm-8">
