                        ...
                        <div class="filter form-inline" style="margin:0 30px 0 0;">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input id="ReportStartdate" type="text" name="startdate" class="form-control input-sm datepicker date-toggle-nep-eng1" value="{{$startOfYear}}">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input id="ReportEnddate" type="text" name="enddate" class="form-control input-sm datepicker date-toggle-nep-eng1" value="{{$endOfYear}}">
                                        <div class="input-group-addon">
                                            <i>
...
@php
    $client=\App\Models\Client::where('ledger_id',$entries['id'])->select('id')->first();
@endphp
                                        <tr>
