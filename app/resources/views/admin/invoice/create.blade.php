			...
			<div class="box-body">
					...
					<table class="table">
						<tbody id="more-tr">
							<tr>
								...
								<td>
									<input type="text" class="form-control input-sm price input-sm" name="price[]" placeholder="Rate" value="@if(isset($orderDetail->price)){{ $orderDetail->price }}@endif" required="required" autocomplete="off" readonly>
								</td>
								<td>
					...
					<table class="table">
						<tbody id="more-custom-tr">
							<tr>
								...
								<td>
									<select name='custom_unit[]' class="form-control input-sm" required="">
										<option value="">Units</option>
										@foreach($prod_unit as $pu)
										<option value="{{ $pu->id }}">{{ $pu->symbol }}</option>
										@endforeach
				...
				<div class="form-section">
                        ...
                        {{ csrf_field() }}
                            ...
                            <div class="col-md-12" style="margin-top: 30px;">
                                <div class="col-md-2">
                                    <div class="callout">
                                        ...
                                        <select class="customer_type select2 form-control" name="client_type" required="required" id='customer_type'>
                            ...
                            <div class="col-md-2">
                                <div class="callout">
                                    <label id='select_label'>Select Clients <i class="imp">*</i> <span id='create_lead_or_clients'>
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                   ...
                                   <!--  <div class="col-sm-10"> -->
                                        ...
                                        [''=>'--SELECT BILL TYPE--','Cash' => 'Cash','Credit'=>'Credit','Staff'=>'Staff'],
                                        'Credit', ['class' => 'form-control input-sm','id'=>'bill_type']) !!}
                                    <!-- </div> -->
                                </div>
                            </div>
                                {{-- <div class="col-md-2">
                            ...
                            <input type="hidden" name="position" value="Manager">
                                ...
                                <div class="col-md-2 form-group" style="">
                                    ...
                                    @if ($admin==true)
                                        {!! Form::select('outlet_id', [''=>'Select']+$productlocation, null, ['class' => 'form-control','required'=>'required']) !!}
                                    @else
                                    @php
                                        $pos_outlets=\App\Models\OutletUser::where('user_id',\Auth::user()->id)->first()->outlet_id??0;
                                    @endphp
                                        {!! Form::select('outlet_id', [''=>'Select']+$productlocation, $pos_outlets, ['class' => 'form-control input-sm', 'id'=>'outlet_id', 'disabled'=>'']) !!}
                                        <input type="hidden" name="outlet_id" id="outlet_id" class="form-control input-sm"  value={{$pos_outlets}}>
                                    @endif
                                </div>
                             {{-- <div class="col-md-2">
                                <div class="form-group">
				...
				function calcTotal() {
					...
					$(".total").each(function(index) {
						if (isNumeric($(this).val()))
							subTotal = Math.round(Number(subTotal) + Number($(this).val()));
					});
					...
					total = Math.round(Number( $('#nontaxableamount').val() ) + Number( $("#taxableamount").val() ) +
