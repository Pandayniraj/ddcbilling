                ...
                <table class="table">
                    <tbody id="more-tr">
                        <tr>
                            ...
                            <td>
                                <input type="text" class="form-control input-sm input-sm price" name="price_new[]" placeholder="Price" value="@if(isset($invoiceDetail->price)){{ $invoiceDetail->price }}@endif" required="required" autocomplete="off">
                            </td>
                            ...
                            <td>
                                <input type="number" class="form-control input-sm  input-sm total" name="total_new[]" placeholder="Total" step="any" value="@if(isset($invoiceDetail->total)){{ $invoiceDetail->total }}@endif" readonly="readonly" style="float:left; width:70%;">
                ...
                <table class="table">
                    <tbody id="more-custom-tr">
                        <tr>
                            ...
                            <td>
                                <input type="number" class="form-control input-sm input-sm total" name="custom_total_new[]" step='any' placeholder="Total" value="@if(isset($invoiceDetail->total)){{ $invoiceDetail->total }}@endif" readonly="readonly" style="float:left; width:70%;">
                                <a href="javascript::void(1);" style="width: 10%;">
                                    <i class="remove-this btn btn-xs btn-danger icon fa fa-trash deletable" style="float: right; color: #fff;"></i>
                                </a>
                            </td>
                    ...
                    <div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                       <!--  <div class="input-group-addon">
                                        ...
                                        <input type="text" name="customer_pan" value="{{ $invoice->customer_pan }}" class="form-control pull-right" id="pan_no" onKeyUp="if(this.value>999999999){this.value='999999999';}else if(this.value<0){this.value='0';}">
                                    </div>
                                    <!-- /.input group -->
                                </div>
                            </div>
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <div class="input-group date">
                                        ...
                                        <input type="text" class="form-control pull-right datepicker date-toggle-nep-eng" name="bill_date" value="{{ $invoice->bill_date }}" id="bill_date">
                                    </div>
                                    <!-- /.input group -->
                                </div>
                            </div>
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <div class="input-group date">
                                        ...
                                        <input type="text" class="form-control pull-right datepicker date-toggle-nep-eng" name="due_date" value="{{ $invoice->due_date }}" id="due_date">
                                    </div>
                                    <!-- /.input group -->
                                </div>
                            </div>
                        ...
                        <div class="col-md-12" style="padding-top: 5px;padding-bottom: 5px">
                            <div class="col-md-4 form-group" style="">
                                ...
                                <input type="text" name="name" id="name" class="form-control" value="{{ $invoice->name }}" required="required">
                            </div>

                            <div class="col-md-2 form-group" style="">
                                <label for="position">Position</label>
                                <input type="text" name="position" class="form-control" id="position" value="{{ $invoice->position }}">
                            </div>
                            <div class="col-md-2 form-group" style="">
                            ...
                            <div class="col-md-2 form-group" style="">
                                ...
                                <select class="form-control outlet_id select2" name="outlet_id" required="required" id='outlet_id'>
                                    ...
                                    <option value="{{ $key }}" @if($invoice && $key ==
                                        $invoice->outlet_id){{ 'selected="selected"' }}@endif>{{ '('.env('APP_CODE'). $key.') '.$name }}</option>
                                    @endforeach
                                    @endif
                                </select>
                          ...
                          <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <select type="text" class="form-control pull-right " name="is_renewal" id="is_renewal">
                                        ...
                                        <option value="1" @if($invoice->is_renewal == '1') selected @endif>Yes</option>
                                    </select>
                                </div>
                                <!-- /.input group -->
                            </div>
                        ...
                        <table class="table">
                            ...
                            <tbody id='multipleDiv'>
                                ...
                                <tr>
                                    ...
                                    <td>
                                     ...
                                     <td>
                                        <input type="number" class="form-control input-sm quantity" name="quantity[]" placeholder="Quantity"  value="{{ $odv->quantity }}" required="required" step=".01">
                                    </td>
                                    <td>
                                        <input type="text" class="form-control input-sm price" name="price[]" placeholder="Price" value="{{ $odv->price }}" required="required">
                                    </td>

                                    <td>
                                        <input type="number" name="dis_amount[]"
                                        class="form-control input-sm discount_amount_line" placeholder="Discount" step="any" value="{{ $odv->discount }}">
                                    </td>
                                    ...
                                    <td>
                                        <select name='units[]' class="form-control input-sm units">
                                            <option value="">Unit</option>
                                            @foreach($prod_unit as $pu)
                                            <option value="{{ $pu->id }}" @if($odv->unit == $pu->id) selected="" @endif>{{ $pu->symbol }}</option>
                                            @endforeach
                                        </select>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select name='custome_unit[]' class="form-control input-sm input-sm">
                                            <option value="">Unit</option>
                                            @foreach($prod_unit as $pu)
                                            <option value="{{ $pu->id }}" @if($odv->unit == $pu->id) selected="" @endif>{{ $pu->name }}({{ $pu->symbol }})</option>
                                            @endforeach
                                        </select>
                                    </td>
                            ...
                            <tfoot>
                                ...
                                <tr>
                                    ...
                                    <td>&nbsp; <input type="hidden" name="subtotal" id="subtotal" value="{{ $invoice->subtotal }}"></td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td> <input type="hidden" name="discount_amount" value="0"
                                        id='discount_amount' value="{{ $invoice->discount_amount }}"> </td>
                                </tr>
                                  ...
                                  <tr>
                                    ...
                                    <td>&nbsp;<input type="hidden" name="non_taxable_amount"
                                        id="nontaxableamount" value="{{ $invoice->non_taxable_amount }}">
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>&nbsp;
                                        <input type="hidden" name="taxable_amount" id="taxableamount" value="{{ $invoice->taxable_amount }}"></td>
                                </tr>
                                <tr>
                       ...
                       <div class="col-md-6 form-group">
                                    ...
                                    <textarea class="form-control TextBox comment" name="comment">@if(isset($invoice)){{ $invoice->comment }}@endif</textarea>
                                </div>

                                <div class="col-md-6 form-group">
                                    <label for="address">Address</label>
                                    <textarea class="form-control TextBox address" name="address" id='physical_address'>{{ $invoice->address }}</textarea>
                                </div>
...
<div class='supplier_options' style="display: none;">
    <div id='_supplier'>
        ...
        @if(isset($clients))
        @foreach($clients as $key => $uk)
        <option value="{{ $uk->id }}" @if($invoice && $uk->id == $invoice->supplier_id){{ 'selected="selected"' }}@endif>{{ '('.$uk->id.') '.$uk->name.' ('.$uk->vat.')' }}</option>
        @endforeach
        @endif
    </div>
    <div id='_paid_through'>
        ...
        <option value="{{ $uk->id }}" @if($invoice && $uk->id == $invoice->supplier_id){{ 'selected="selected"' }}@endif>{{ '('.$uk->id.') '.$uk->name.' ('.$uk->location.')' }}</option>
        @endforeach
        @endif
    </div>
</div>
