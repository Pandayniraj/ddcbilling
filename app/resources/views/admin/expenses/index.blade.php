    ...
    <div class='col-md-12'>
        ...
        <div class="box box-primary">
            ...
            <div class="box-header with-border">
                ...
                &nbsp;
                <a class="btn btn-primary btn-sm" href="{!! route('admin.expenses.create') !!}" title="Create New Expense">
                 New Expense &nbsp; <i class="fa fa-plus-square"></i>
                </a>
                &nbsp;
...
{{--                    <a href="/admin/download/expenses/pdf/index" class="btn btn-success btn-xs float-right no-loading" style="margin-right: 20px;">PDF Download</a>--}}
                    ...
                    <button type="submit" name="submit" value="excel" class="btn btn-default btn-xs float-right no-loading">
                        Excel Download
                    </button>
{{--
                    ...
                    <div class="filter form-inline" >
                        <div class="row">
                            <div class="col-md-2">
                                ...
                                <select name="user" id="user" class="form-control formspace select2">
                            ...
                            <div class="col-md-2">
                                {!! Form::text('start_date', \Request::get('start_date'), ['class' => 'form-control formspace input-sm date-toggle-nep-eng1', 'id'=>'start_date', 'placeholder'=>'Start Date','autocomplete' =>'off']) !!}
                            </div>
                            <div class="col-md-2">
                                {!! Form::text('end_date', \Request::get('end_date'), ['class' => 'form-controlformspace input-sm date-toggle-nep-eng1', 'id'=>'end_date', 'placeholder'=>'End Date','autocomplete' =>'off']) !!}
                            </div>
                            <div class="col-md-2">
                                <select class='form-control formspace searchable select2' style="width: 215px!important;" name="paid_through" id="paid_through">
                            ...
                            <div class="col-md-2">
                                <button class="btn btn-default btn-sm" id="btn-submit-filter" type="submit">
                                    <i class="fa fa-list"></i> Filter
                                </button>

                                <a href="/admin/expenses" class="btn btn-default btn-sm" id="btn-filter-clear" >
...
<thead>
    <tr class="bg-gray">
        ...
        <th style="whitespace:nowrap;">EXP ID</th>
        <th>#JV</th>
        <th>Bill#</th>
        @if(\Auth::user()->hasRole(['admins']))
        <th>User</th>
