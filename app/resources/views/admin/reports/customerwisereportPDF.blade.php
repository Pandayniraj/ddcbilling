...
<body>
    ...
    <div class="row">
        ...
        @foreach ($clients as $client)
            <tr>
                ...
                @php
                    ...
                    ->where('bill_date','>=',$nepalistartdate)
                    ->where('bill_date','<=',$nepalistartdate)
                    ->pluck('id');
      ...
      <div class="row">
          ...
          <div class="col col-xs-4">Submitted By</div>
          <div class="col col-xs-4">Marketing Officer</div>
          <div class="col col-xs-4">Project Manager</div>
