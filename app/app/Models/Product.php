...
class Product extends Model
{
     ...
     * @var array
     */
    protected $fillable = ['name', 'cost', 'distributor_price', 'retailer_price', 'boothman_price', 'direct_customer_price','price', 'enabled', 'public', 'category_id', 'org_id', 'ordernum', 'alert_qty', 'product_code', 'sku', 'product_unit', 'product_image', 'ledger_id', 'is_fixed_assets','type','is_vat'];
