    ...
    <div class='row'>
        <div class='col-md-12'>
            <div class="box box-primary">
                <div class="row">
                    <div class="col-md-6">
                        {!! Form::open( ['route' => ['admin.product-pricing.store', $product->id], 'id' => 'add-product-price','enctype'=>'multipart/form-data'] ) !!}
                        <div class="content">
                        ...
                        <div class="form-group">
                            {!! Form::button( trans('general.button.create'), ['class' => 'btn btn-primary btn-sm', 'id' => 'btn-submit-edit','type'=>'Submit'] ) !!}
        ...
        $(document).ready(function () {
            ...
            $(document).on("change", "#project-id", function (e) {
                $.ajax({
                    ...
                    type: 'POST',
                    data: {project_id: $("#project-id").val(), product: {{$product->id}}, product_price_id: 0, _token: '{{ csrf_token() }}'},
