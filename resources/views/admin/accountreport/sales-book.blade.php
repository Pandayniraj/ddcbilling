    ...
    <div class="box-header with-border">
        ...
        <div class="col-md-6 pull-left">   
           ...
           <div class="input-group">
                  ...
                  <input type="text" placeholder="End Date" class="form-control enddate" name='engenddate'>
                </div>
            ...
            <div class="col-md-4">
              <div class="input-group">
                     ...
                     <Select class="form-control enddate" name='outlet'>
                      <option>Select Outlet</option>
                      @foreach ($posoutlets as $posoutlet)
                        <option value={{ $posoutlet->id }}>{{ $posoutlet->name }} </option>
                      @endforeach
                     </select>
                   </div>
...
<tr>
 ...
 <?php  
  ...
  @endif
    ...
    <td>@if($sal_bks->taxable_amount>=1)-@endif{{$sal_bks->taxable_amount}}</td>
    <td>@if($sal_bks->tax_amount>=1)-@endif{{$sal_bks->tax_amount}}</td>
</tr>
