            ...
            <div class="box box-primary">
                        ...
                        <div class="col-md-6 pull-left">
                            <div class="col-md-4">
                                <div class="input-group">
                                    ...
                                    <input type="text" placeholder="Start Date" class="form-control input-sm startdate"
                                           name='engstartdate'>
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="input-group">
                                    ...
                                    <input type="text" placeholder="End Date" class="form-control enddate"
                                           name='engenddate'>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="input-group">
                                    ...
                                    <Select class="form-control searchable" name='outlet' required>
                                        <option>Select Outlet</option>
                                        @foreach ($posoutlets as $posoutlet)
                                            <option value={{ $posoutlet->id }} @if(request()->outlet == $posoutlet->id) selected @endif>{{ $posoutlet->name }} </option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6 pull-right">
                            <div class="col-md-4">
                                <div class="input-group">
                                    ...
                                    <input type="text" placeholder="सुरु  मिति " class="form-control input-sm"
                                           id='nep-startdate' name="nepstartdate">
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="input-group">
                                    ...
                                    <input type="text" placeholder="अन्तिम मिति" class="form-control input-sm"
                                           id='nep-enddate' name="nependdate">
                                </div>
                            </div>
                ...
                <table class="table table-hover table-bordered table-stripped" id="leads-table">
                    ...
                    @foreach($sales_book as $sal_bks)
                        <tr>
                            <td>{{ \App\Helpers\TaskHelper::getNepaliDate($sal_bks->bill_date) }}
                                {{-- {{ date('dS M y', strtotime($sal_bks->bill_date)) }}/<br/>--}}
                                {{--     <?php--}}
                            ...
                            <td></td>
                                <?php
                                $nontaxable_amount += $sal_bks->total_amount - ($sal_bks->tax_amount + $sal_bks->taxable_amount) >= 1 ? $sal_bks->total_amount - ($sal_bks->tax_amount + $sal_bks->taxable_amount) : 0;
                            ...
                            <?php
                            $taxable_amount += $sal_bks->taxable_amount;
                            $tax_amount += $sal_bks->tax_amount;
                        ...
                        @if(!$sal_bks->invoicemeta->is_bill_active)
                            <tr>
                                <td>
                                    {{\App\Helpers\TaskHelper::getNepaliDate($sal_bks->bill_date)}}
                                    {{-- {{ date('dS M y', strtotime($sal_bks->bill_date)) }}/<br/>--}}
                                    {{--     <?php--}}
                                    {{--     $temp_date = explode(" ", $sal_bks->bill_date);--}}
                                    {{--     $temp_date1 = explode("-", $temp_date[0]);--}}
                    ...
                    <tr>
                        ...
                        <td>{{ number_format($nontaxable_amount, 2) }}</td>
                        <td></td>
                        <td></td>
...
@section('body_bottom')
    ...
    <script type="text/javascript"
            src="https://nepali-date-picker.herokuapp.com/src/jquery.nepaliDatePicker.js"></script>
    <!-- form submit -->
