                    ...
                    <div class="box-header with-border">
                        ...
                        <div class="col-md-4 col-sm-4 col-lg-4" style="float: right;margin-top: 4px">
                            <div class="input-group">
                                <input type="text" class="form-control input-sm" placeholder="Search clients"
                                    name="search" id="terms" value="{{ \Request::get('term') }}">
                                ...
                                @foreach ($clients as $client)
                                    <tr>
                                        ...
                                        <td class=""><span style="font-size: 17px">
                                                ...
                                                <a
                                                    href="/admin/clients/{{ $client->id }}?relation_type={{ $client->relation_type }}">
                                                    {{ $client->name }}</a>
                                            </span></td>
                                        <td><small>{{ $client->ledger->name }}</small></td>
                                        <td>{!! mb_substr($client->phone, 0, 16) !!}</td>
                                        <td> <i class="fa fa-external-link"></i> <a target="_blank"
                                                href="http://{!! $client->website !!}"> {!! mb_substr($client->website, 0, 10) . '..' !!}</a></td>
...
@section('body_bottom')
    ...
    <script language="JavaScript">
        ...
        function search() {
            ...
            let url =
                `{!! url('/') !!}/admin/{{ \Request::segment(2) }}?term=${terms}&clients_types=${clients_types}`;
            console.log(url);
        ...
        $('#clear').click(function() {
            window.location.href =
                "{!! url('/') !!}/admin/customer?relation_type={{ \Request::get('relation_type') }}";
        })
        $('.searchable').select2();
    </script>
@endsection
