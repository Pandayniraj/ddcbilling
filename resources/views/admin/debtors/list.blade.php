                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input id="ReportStartdate" type="text" name="startdate"
                                                       class="form-control input-sm datepicker date-toggle-nep-eng1"
                                                       value="{{$startOfYear}}">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <div class="input-group">
                                                ...
                                                <select id="fiscal_year_id" class="form-control input-sm"
                                                        name="fiscal_year" required="required">
                                ...
                                <div>
                                    <table class="table table-hover table-striped table-responsive" id="clients-table">
                                        ...
                                        @foreach($debtorsLists as $key=>$entries)
                                            @php $client=\App\Models\Client::where('ledger_id',$entries['id'])->select('id')->first(); @endphp
                                            <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="5" class="text-right"
                                                style="font-size: 20.5px;">{{ env('APP_CURRENCY') }} {{ number_format($totalSum,2) }} </td>
                                        </tr>
                                        </tfoot>
                                    </table>
                                </div>
...
@section('body_bottom')
    ...
    <script
        src="{{ asset ("/bower_components/admin-lte/plugins/datatables/extra/dataTables.buttons.min.js") }}"></script>
