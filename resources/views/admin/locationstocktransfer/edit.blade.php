                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" class="form-control availablity" name="availablity[]"
                                       placeholder="Available" value="0" required="required">
                            </td>
                            <td>
                            ...
                            <div class="">
                                ...
                                <div class="col-md-12">
                                    <div class="col-md-12">
                                        ...
                                        <div class="col-md-3 form-group" style="">
                                            ...
                                            <input type="text"
                                                   ...
                                                   name="transfer_date"
                                                   value="{{$locationstocktransfer->transfer_date}}" id="bill_date">
                                        </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="col-md-3 form-group" style="">
                                            ...
                                            {!! Form::select('destination_id',  $destination_locations, $locationstocktransfer->destination_id, ['class' => 'form-control input-sm', 'id'=>'destination_id']) !!}
                                        </div>
                                    </div>
                                    ...
                                    <table class="table table-striped">
                                        ...
                                        @if($locationstocktransferdetail)
                                            @foreach($locationstocktransferdetail as $lst)
                                                ...
                                                <tr>
                                                    <td>
                                                        <select class="form-control product_id hiddensearchable select2"
                                                    ...
                                                    <td>
                                                        <input type="text" class="form-control availablity"
                                                               name="availablity[]" placeholder="Available" value="0"
                                                               required="required">
                                                    </td>
                                                    <td>
                                    ...
                                    <div class="box">
                                        <div class="box-header with-border">
                                            ...
                                            <div class="col-md-6 form-group" style="margin-top:5px;">
                                                ...
                                                <textarea class="form-control TextBox comment" name="comment">@if(isset($locationstocktransfer->comment))
                                                        {{ $locationstocktransfer->comment }}
                                                    @endif</textarea>
                                            </div>
                                ...
                                <div class="panel-footer footer">
                                    ...
                                    <a class="btn btn-social btn-foursquare"
                                       href="/admin/orders/?type={{ $_GET['type']}}"> <i class="fa fa-times"></i> Cancel
                                    </a>
