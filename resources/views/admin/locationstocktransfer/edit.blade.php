                           ...
                           <div class="col-md-12">
                                ...
                                <div class="col-md-3 form-group" style="">
                                    <label for="comment">Transfer Date </label>
                                      <input type="text" class="form-control input-sm pull-right datepicker date-toggle-nep-eng" name="transfer_date" value="{{$locationstocktransfer->transfer_date}}" id="bill_date">
                                </div>
