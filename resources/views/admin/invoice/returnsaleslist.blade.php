        ...
        <div class="col-md-12">
           ...
           ?>
                    ...
                    <tr>
                        ...
                        <td>{{$o->invoicemeta->void_reason??''}}</td>
                        ...
                        <td>{{ $o->total_amount - ($o->taxable_amount+$o->tax_amount)>=1?$o->total_amount - ($o->taxable_amount+$o->tax_amount):0 }}</td>
                        <td></td>

                        <td>{!! number_format($o->taxable_amount,2) !!}</td>
                        <td>{!! number_format($o->tax_amount,2) !!}</td>
                        <?php
                                   $pos_nontaxable_amount += $o->total_amount - ($o->taxable_amount+$o->tax_amount)>=1?$o->total_amount - ($o->taxable_amount+$o->tax_amount):0; 
                ...
                <tfoot>
                    ...
                    <td colspan="2">{{ env('APP_CURRENCY') }}{{ number_format($pos_nontaxable_amount, 2)}}</td>
                    <td>
