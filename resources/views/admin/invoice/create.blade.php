					...
					<table class="table">
						<tbody id="more-tr">
							<tr>
								...
								<td class="col-sm-1">
									<input type="number" class="form-control input-sm quantity input-sm" name="quantity[]" placeholder="Quantity" step=".01" autocomplete="off">
								</td>

								<td>
									<input type="text" class="form-control input-sm price input-sm" name="price[]" placeholder="Rate" value="@if(isset($orderDetail->price)){{ $orderDetail->price }}@endif" autocomplete="off" readonly>
								</td>
								...
								@endif
								<td>
									<select name='units[]' class="form-control input-sm input-sm units" readonly>
								...
								<td class="col-sm-1">
									<select class="form-control input-sm tax_rate_line input-sm" name="tax_type[]" disabled>
								...
								<td>
									<input type="number" class="form-control input-sm total input-sm" name="total[]" placeholder="Total" value="@if(isset($orderDetail->total)){{ $orderDetail->total }}@endif" style="float:left; width:70%;" step='any' readonly>
					...
					<table class="table">
						<tbody id="more-custom-tr">
							<tr>
								...
								<td class="col-sm-1">
									<input type="number" class="form-control input-sm quantity input-sm" name="custom_items_qty[]" placeholder="Quantity" step=".01" autocomplete="off">
								</td>

								<td>
									<input type="text" class="form-control input-sm price" name="custom_items_price[]" placeholder="Price" value="@if(isset($orderDetail->price)){{ $orderDetail->price }}@endif" autocomplete="off">
								</td>
								@if(\Auth::user()->hasRole('admins'))
								<td>
                        ...
                        {{ csrf_field() }}
                            ...
                            <div class="col-md-12" style="margin-top: 30px;">
                                <div class="col-md-2" style="display:block;" id="long">
                                    <div class="callout">
                                        <label id='select_label'>Client Type</label>
                                        <select class="customer_type select2 form-control" name="client_type" required="required" id='customer_type' style="display: block;">
                            ...
                            <div class="col-md-2" id="onclienttype" style="display: block;">
                                <div class="callout">
                                    <label id='select_label'><span >Select Clients</span> <i class="imp">*</i> <span id='create_lead_or_clients'>
                                        <a href="#" onClick="openwindow('client')"><i class="fa fa-plus plusicon"></i></a>
                                    </span></label>
							...
							<div class="col-md-2" id="show" style="display: none;">
                                <div class="callout">
                                    <label id='select_label'><span >Client Name</span> <i class="imp">*</i> <span id='create_lead_or_clients'>
                                    </span></label>
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
									...
									<select name="bill_type" class="form-control" id="bill_type" style="display:block;">
									...
									<select name="bill_type_one" class="form-control" id="forrandom" style="display:none;">
										<option value="">Select BILL TYPE</option>
										<option value="Cash">Cash</option>
									</select>

									<select name="bill_type_two" class="form-control" id="billshow" style="display:none;">
										<option value="">Select BILL TYPE</option>
										<option value="Staff">Staff</option>
									</select>
                                   <!--  <div class="col-sm-10"> -->
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <div class="date">
                                            ...
                                            <input type="text" name="customer_pan" value="{{ old('customer_pan')}}" class="form-control pull-right" id="pan_no" onKeyUp="if(this.value>999999999){this.value='999999999';}else if(this.value<0){this.value='0';}" readonly>
                                        </div>
                                        <!-- /.input group -->
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="date">
                                           <!--  <div class="input-group-addon">
                                            ...
                                            <input type="text" class="form-control input-sm pull-right datepicker date-toggle-nep-eng" name="bill_date" value="{{\Carbon\Carbon::now()->toDateString()}}" id="bill_date">
                                        </div>
                                        <!-- /.input group -->
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="date">
                                           <!--  <div class="input-group-addon">
                                            ...
                                            <input type="text" class="form-control pull-right datepicker date-toggle-nep-eng" name="due_date" value="{{\Carbon\Carbon::now()->addDays(14)->toDateString()}}" id="due_date">
                                        </div>
                                        <!-- /.input group -->
                                    </div>
                                </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-md-2 form-group credit" style="">
                                    ...
                                    @else
                                    {!! Form::select('user_id', $users, \Auth::user()->id, ['class' => 'form-control input-sm', 'id'=>'user_id', 'disabled'=>'']) !!}
                                ...
                                <div class="col-md-2 form-group credit" style="">
                                    ...
                                    {!! Form::text('credit_limit',null,  ['class' => 'form-control input-sm ', 'id'=>'credit_limit' ,'readonly'=>'readonly']) !!}
                                </div>
                                {{-- <div class="col-md-2 form-group credit" style="">
                                ...
                                <div class="col-md-2 form-group credit" style="">
                                    ...
                                    {!! Form::text('remaining_amount',null,  ['class' => 'form-control input-sm ', 'id'=>'remaining_amount' ,'readonly'=>'readonly']) !!}
                                </div>
                                {{-- <div class="col-md-2 form-group" style="">
                            ...
                            <input type="hidden" name="position" value="Manager">
                                ...
                                <div class="col-md-2 form-group" style="">
                                    <i class="fa fa-store"></i><label for="user_id">Outlets</label>
									@if(\Auth::user()->hasRole('admins'))
								...
								@else
									<select name="outlet_id" class="form-control" id="outlet_id">
										...
										<option value={{ $outlet->outlet->id??'' }}>{{ $outlet->outlet->name??'' }}</option>
									@endforeach
									</select>
                                    @endif
                                </div>
							...
							<br/>
							   ...
							   <div class="col-md-6 form-group" style="margin-top:5px;">
                                ...
                                <div class="col-md-6 form-group" style="margin-top:5px;">
                                        ...
                                        <textarea class="form-control TextBox address" name="address" id='physical_address'>@if(isset($orderDetail->address)){{ $orderDetail->address }}@endif</textarea>
                                </div>
						</div>
			...
			<script>
				...
				$(document).on('change', '.product_id', function() {
					...
					if (this.value != 'NULL') {
						...
						$.ajax({
							...
							, url: "/admin/products/GetProductDetailAjax/" + this.value + '?_token=' + _token+'&client='+ $('#client_id').val()
				...
				$(document).on('change', '.tax_rate', function() {
					...
					if (isNumeric(tax) && tax != 0 && (total != 0 || total != '')) {
						...
						parentDiv.find('.tax_amount').val(tax_amount);
						total = Math.round(total + tax_amount);
					} else
					parentDiv.find('.tax_amount').val('0');
