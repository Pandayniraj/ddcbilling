                    ...
                    <div class="panel-heading">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <input type="text" name="start_date" class="form-control datepicker date-toogle"
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <input type="text" name="start_time" class="form-control timepicker" required=""
                                           placeholder="Start time" value="{{$request['start_time'] ?? date('h:i')}}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <input type="text" name="end_date" class="form-control datepicker date-toogle"
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <input type="text" name="end_time" class="form-control timepicker" required=""
                                           placeholder="End Date" value="{{$request['end_time'] ?? date('h:i')}}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <label>Outlet</label>
                                <div class="form-group">
                                    <select name="outlet" class="form-control searchable">
                                        <option value=""> Select Outlet</option>
                                        @foreach ($posoutlet as $outlet )
                                            <option value={{ $outlet->id }}>{{$outlet->name}} #({{$outlet->outlet_code}} ({{$outlet->id}}))</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <a href="/admin/ird/materializeview" class="btn btn-success btn-sm">Generate</a>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    @if(isset($sales))
        <div class="panel panel-custom" id='scroll-me'>
            ...
            <div class="pannel-body">
                ...
                <a href="{{$url}}op=excel" class="btn btn-default">Excel</a>
