    ...
    <h2 style="margin-top: -10px;">Credit Note</h2>
        ...
        <!-- /.col -->
        <div class="col-sm-4 invoice-col">
          <b>Credit Note Number: #CN{{ $creditnote_no }}</b><br>
          ...
          <table id="" class="table table-striped">
            ...
            <tbody>
                ...
                <tr>
                  ...
                  <td>{{ $odv->quantity }}</td>
                  <?php
                  $total= $odv->total-$ord->tax_amount??0;
                  ?>
                  <td>{{ env('APP_CURRENCY').' '.number_format($total,2) }}</td>
                </tr>
                @endforeach
            </tbody>
          </table>
          ...
          <div class="table-responsive">
            <table id="" class="table table-striped">
              <tbody>
                ...
                <th style="width:50%" >Sub Total:</th> <td>{{ env('APP_CURRENCY').' '. number_format($total,2) }}</td>
              </tr>
               <tr style="padding:0px; margin:0px;">
