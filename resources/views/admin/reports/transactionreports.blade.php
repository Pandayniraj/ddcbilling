        ...
        <div class='col-md-12'>
            <div class="box">
                <div class="box-header">
                    {!! Form::open(['route' => 'admin.reports.transactionreports', 'id' => 'transaction_report' , 'method'=>'GET']) !!}
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-md-2">
                    ...
                    @if(isset($detail_transaction))
                        <div class="download-print float-right">
                            <button class="btn btn-sm btn-primary" type="submit" value="export" name="type"><i class="fa fa-file"></i>  Excel</button>
                            <button class="btn btn-sm btn-success" type="submit" value="print" name="type"><i class="fa fa-print"></i> Pdf </button>
                        </div>
                    @endif
                    {!! Form::close() !!}
                </div>
            ...
            @if(isset($detail_transaction))
                <div class="box">
                    <div class="box-body">
                        ...
                        <p><b>Transaction Report </b>{{ $outletname->name}}</p>
                            ...
                            <table class="table table-striped">
                                ...
                                @foreach ($clients as $key=>$client)
                                    <tr>
                                        ...
                                        <td class="align-center">{{(double)$period_cr_amount}}</td>
                                        <td class="align-center">{{(double)($dr_amount-$period_cr_amount)}}</td>
                                        <td class="align-center">{{(double)$overall_dr->dr_total - $overall_paid->cr_amount}}</td>
                                    </tr>
