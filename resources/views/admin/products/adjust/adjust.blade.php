            ...
            <div class="row col-md-12">
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="text" name="startdate" id="startdate" class="form-control input-sm datepicker date-toggle-nep-eng" value="{{Request::get('startdate')}}">
                ...
                <div class="col-md-2">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="text" name="enddate" id="enddate" class="form-control input-sm datepicker date-toggle-nep-eng" value="{{Request::get('enddate')}}">
                            <div class="input-group-addon">
                                <i>
