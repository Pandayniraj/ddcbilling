                ...
                <form id="attendance-form" role="form" enctype="multipart/form-data" action="/admin/product/statement" method="GET" class="form-horizontal form-groups-bordered">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            ...
                            <input type="date" name="start_date" class="form-control datepicker date-toggle-nep-eng" value="{{ Request::get('start_date') }}">
                        </div>

                        <div class="col-sm-3">
                            <label class="control-label">End date</label>
                            <input type="date" name="end_date" class="form-control datepicker date-toggle-nep-eng"  value="{{ Request::get('end_date') }}" >
                        </div>
