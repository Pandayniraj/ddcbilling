            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    ...
                    @if(\Auth::user()->hasRole('admins'))
                        <a class="btn btn-default btn-sm" href="{!! route('admin.products.create') !!}"
                    ...
                    <a class="btn btn-default btn-sm" href="#"
                       onclick="document.forms['frmCourseList'].action = '{!! route('admin.products.enable-selected') !!}';  document.forms['frmCourseList'].submit(); return false;"
                       title="{{ trans('general.button.enable') }}">
                        <i class="fa fa-check-circle"></i>
                    </a>
                    &nbsp;
                    <a class="btn btn-default btn-sm" href="#"
                       onclick="document.forms['frmCourseList'].action = '{!! route('admin.products.disable-selected') !!}';  document.forms['frmCourseList'].submit(); return false;"
                    ...
                    <a href="{!! route('admin.download.products.pdf.index') !!}">
                        <button class="btn btn-info btn-sm"><i class="fa  fa-file-pdf-o">&nbsp;</i> PDF Export</button>
                    </a>

                    <a class="btn btn-primary btn-sm" href="{{route('admin.products.import-export')}}"
                       title="Import/Export Budget">
                    ...
                    <div class="box-tools pull-right">
                        <form method="GET" action="/admin/products">
                            ...
                            <input type="text" class="input-sm" placeholder="Type To search..." id='search-term'
                                   name="term">
                            <button class="btn btn-primary btn-sm" id='search' type="submit"><i
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover table-bordered table-striped" id="courses-table">
                                ...
                                @foreach($courses as $course)
                                    <tr>
                                        <td>{!! \Form::checkbox('chkCourse[]', $course->id) !!}</td>
                                        <td style="text-align: center;">
                                            ...
                                            @else
                                                <img src="{{ TaskHelper::getAvatarAttribute($course->name) }}"
                                                     height="22" width="22"/>
                                            @endif
                                        </td>
                                        ...
                                        <td><a target="_blank"
                                               href="/admin/products/barcode/{!! $course->id !!}/create">Print</a></td>
