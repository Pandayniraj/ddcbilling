        ...
        <div class="tab-content">
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="content">
                            ...
                            <hr/>
                            <a class="btn btn-sm btn-primary">Add Project Price</a>
                            ...
                            <div class="form-group">
                                <div class="checkbox">
                                    <label>
                                        ...
                                        {!! Form::checkbox('is_vat', '1', $course->is_vat) !!}
                                        Is Vat
                                    </label>
                                </div>
                            </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="number" name="staff_quota" placeholder="Staff Quota Limit"
                                       class="form-control" value="{{$course->staff_quota}}">
                            </div>
                            <?php
            ...
            <div style="min-height:200px" class="tab-pane" id="tab_4">
                <div class="pull-right">
                    <a class="btn btn-xs btn-success" href="/admin/products/{{$course->id}}/trans/excel/csv">Download
                        Excel</a><br>
                </div>
